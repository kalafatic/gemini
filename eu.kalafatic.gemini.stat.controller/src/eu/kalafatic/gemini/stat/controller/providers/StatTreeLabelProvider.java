...
import eu.kalafatic.gemini.stat.controller.Activator;
import eu.kalafatic.gemini.stat.model.statistics.Study;

/**
 * The Class class StatTreeLabelProvider.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class StatTreeLabelProvider extends LabelProvider {

	/** The Constant STUDY_IMG. */
	public static final Image STUDY_IMG = Activator.getImageDescriptor("icons/study.png").createImage();

	/** The Constant GRAPH_IMG. */
	public static final Image GRAPH_IMG = Activator.getImageDescriptor("icons/stat.gif").createImage();

	/**
	 * Instantiates a new stat tree label provider.
	 * @param viewer the viewer
	 */
	public StatTreeLabelProvider(TreeViewer viewer) {
		// this.viewer = viewer;
	}
	...
	public Image getImage(Object element) {
		if (element instanceof HashMap<?, ?>) {
			...
			if (entry.getValue() instanceof Study) {
				return STUDY_IMG;
			}
