 ...
 ******************************************************************************/
package eu.kalafatic.gemini.media.controller.lib;

import eu.kalafatic.gemini.core.interfaces.IPreference;

/**
 * The Enum enum EMediaPreferences.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public enum EMediaPreferences implements IPreference {
	...
	/**
	 * Instantiates a new e media preferences.
	 * @param index the index
	 * @param name the name
	 * @param value the value
	 * @param def the def
	 */
	private EMediaPreferences(int index, String name, Object value, Object def) {
		this.index = index;
		this.name = name;
		this.value = value;
		this.def = def;
