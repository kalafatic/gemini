...
import eu.kalafatic.gemini.bt.client.net.rc.controller.PreferenceInitializer;
...
/**
 * The Class class RCPreferencePage.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class RCPreferencePage extends APreferencePage {
	...
	/**
	 * Instantiates a new rC preference page.
	 */
	public RCPreferencePage() {
		super.noDefaultAndApplyButton();
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription(Activator.getPluginProperties().getString("RCPreferencePage"));
	}
