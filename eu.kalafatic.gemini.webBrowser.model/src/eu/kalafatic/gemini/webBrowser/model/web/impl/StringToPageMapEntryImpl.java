...
public class StringToPageMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, Page> {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.STRING_TO_PAGE_MAP_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.STRING_TO_PAGE_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(Page newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypedValue(Page newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject) newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE, null, msgs);
			msgs = basicSetTypedValue(newValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WebPackage.STRING_TO_PAGE_MAP_ENTRY__KEY:
			return getTypedKey();
		case WebPackage.STRING_TO_PAGE_MAP_ENTRY__VALUE:
