...
import static eu.kalafatic.gemini.core.lib.constants.FCMDConstants.GET_CPU_NAME;
import static eu.kalafatic.gemini.core.lib.constants.FCMDConstants.GET_CPU_SPEED;
import static eu.kalafatic.gemini.core.lib.constants.FCMDConstants.REGDWORD_TOKEN;
import static eu.kalafatic.gemini.core.lib.constants.FCMDConstants.REGSTR_TOKEN;
...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public static void setUp() {
		try {
			...
			// SYSTEM
			preferences.put(ECorePreferences.CPU_NAME.getName(), WinRegistryUtils.getFromRegistry(GET_CPU_NAME, REGSTR_TOKEN));
			preferences.put(ECorePreferences.CPU_SPEED.getName(), WinRegistryUtils.getFromRegistry(GET_CPU_SPEED, REGDWORD_TOKEN));
