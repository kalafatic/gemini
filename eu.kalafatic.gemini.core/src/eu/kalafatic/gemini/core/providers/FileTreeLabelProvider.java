...
import static eu.kalafatic.gemini.core.lib.constants.FCoreImageConstants.DRIVE_IMG_1;
import static eu.kalafatic.gemini.core.lib.constants.FCoreImageConstants.DRIVE_IMG_2;
...
public class FileTreeLabelProvider implements ILabelProvider {
	...
	public Image getImage(Object element) {
		...
		if (file.isDirectory()) {
			return file.getParent() != null ? FOLDER_IMG : DRIVE_IMG_1;
		} else if (file.isFile()) {
			return FILE_IMG;
		}
		return DRIVE_IMG_2;
