...
public class CommandFactory {
	...
	public boolean executeCommand(String commandID, String... args) {
		...
		try {
			...
			ParameterizedCommand parameterizedCommand = createParametrizedCommand(command, args);

			// ExecutionEvent execEvent = handlerService.createExecutionEvent(parameterizedCommand, null);
			// parameterizedCommand.executeWithChecks(null, null);
	 ...
	 * @throws NotDefinedException the not defined exception
	 */
	private ParameterizedCommand createParametrizedCommand(Command command, String... args) throws NotDefinedException {
