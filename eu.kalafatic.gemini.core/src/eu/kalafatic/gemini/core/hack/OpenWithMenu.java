...
public class OpenWithMenu extends ContributionItem {
	...
	/**
	 * Gets the image.
	 * @param editorDesc the editor desc
	 * @return the image
	 */
	 ...
	 * @param preferredEditor the preferred editor
	 */
		...
		Listener listener = new Listener() {
			...
			public void handleEvent(Event event) {
				...
				case SWT.Selection:
					...
					dialog.setMessage(NLS.bind(IDEWorkbenchMessages.OpenWithMenu_OtherDialogDescription, file.getName()));
					if (dialog.open() == Window.OK) {
						IEditorDescriptor iEditorDesc = dialog.getSelectedEditor();
						if (iEditorDesc != null) {
