...
class BasicSplashHandler extends AbstractSplashHandler {
	...
	/**
	 * Sets the foreground.
	 * @param foregroundRGB the new foreground
	 */
	 ...
	 * @param messageRect the new message rect
	 */
	 ...
	 * @param progressRect the new progress rect
	 */
	...
	/**
	 * Sets the end splash.
	 * @param endSplash the new end splash
	 */
