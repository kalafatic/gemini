...
public final class FTableConstants {
	...
	public static final int TAB_STYLE_1 = SWT.SINGLE | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.HIDE_SELECTION;

	/** The Constant TAB_STYLE_2. */
	public static final int TAB_STYLE_2 = SWT.BORDER | SWT.CHECK | SWT.MULTI | SWT.FULL_SELECTION;

	/** The Constant TAB_STYLE_3. */
	public static final int TAB_STYLE_3 = SWT.BORDER | SWT.CHECK | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION;
	...
	public static final String[] TORRENTS_COL_NAMES = new String[] { NAME_COL, SIZE_COL, DOWNLOADED_COL, COMPLETED_COL, DWNLD_SPEED_COL, UPLD_SPEED_COL };
	...
	// Set column names
	/** The torrent details col names. */
	public String[] TORRENT_DETAILS_COL_NAMES = new String[] { NAME_COL, VALUE_COL, DESCRIPTION_COL };
	...
	// Set column names
	/** The torrent details row names. */
	public String[] TORRENT_DETAILS_ROW_NAMES = new String[] { NAME_ROW, TRACKER_ROW, BITMAP_ROW };

	// client detail table
	// Set column names
	/** The clientt details col names. */
	public String[] CLIENTT_DETAILS_COL_NAMES = new String[] { NAME_COL, VALUE_COL, DESCRIPTION_COL };
	...
	// Set column names
	/** The client details row names. */
	public String[] CLIENT_DETAILS_ROW_NAMES = new String[] { PROTOCOL_ROW, HOST_ROW, PORT_ROW, APP_ROW, BITMAP_ROW, DESCRIPTION_ROW };
