...
public final class FUIConstants {
	...
	public final static int BTN_WIDTH = 60;

	/** The Constant BTN_HEIGHT. */
	public final static int BTN_HEIGHT = 20;
	...
	public final static int SECTION_STYLE = Section.TITLE_BAR | Section.TWISTIE | Section.COMPACT;
