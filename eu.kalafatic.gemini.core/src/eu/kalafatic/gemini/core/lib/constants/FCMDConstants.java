...
import static eu.kalafatic.gemini.core.lib.constants.FRegistryConstants.HKCU_ENV;
import static eu.kalafatic.gemini.core.lib.constants.FRegistryConstants.HKLM_ENV;
...
public final class FCMDConstants {
	...
	public static final String GET_USER_ENV = REG_QUERY + "\"" + HKCU_ENV + "\"" + " /v Path";

	/** The Constant GET_SYSTEM_ENV. */
	public static final String GET_SYSTEM_ENV = REG_QUERY + "\"" + HKLM_ENV + "\"" + " /v Path";
