...
public class StringToFolderMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, Folder> {
	...
	protected EClass eStaticClass() {
		return RcPackage.Literals.STRING_TO_FOLDER_MAP_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RcPackage.STRING_TO_FOLDER_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(Folder newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypedValue(Folder newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject) newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE, null, msgs);
			msgs = basicSetTypedValue(newValue, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RcPackage.STRING_TO_FOLDER_MAP_ENTRY__KEY:
			return getTypedKey();
		case RcPackage.STRING_TO_FOLDER_MAP_ENTRY__VALUE:
