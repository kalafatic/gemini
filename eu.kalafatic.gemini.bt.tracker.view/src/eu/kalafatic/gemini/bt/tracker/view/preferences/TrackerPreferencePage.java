...
import eu.kalafatic.gemini.bt.tracker.controller.PreferenceInitializer;
import eu.kalafatic.gemini.bt.tracker.view.Activator;
...
public class TrackerPreferencePage extends APreferencePage {
	...
	public TrackerPreferencePage() {
		...
		setDescription(Activator.getPluginProperties().getString("TrackerPreferencePageDescription"));
	}
