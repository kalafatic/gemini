...
import eu.kalafatic.gemini.bt.client.view.Activator;
...
/**
 * The Class class ClientPreferencePage.
 * @author Petr Kalafatic
 * @version 3.0.0
 * @project Gemini
 */

public class ClientPreferencePage extends APreferencePage {
	...
	/** The cl pref desc. */
	private final String CL_PREF_DESC = Activator.getPluginProperties().getString("ClientPreferencePageDescription");

	/**
	 * Instantiates a new client preference page.
	 */
	public ClientPreferencePage() {
		super.noDefaultAndApplyButton();
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription(CL_PREF_DESC);
	}
