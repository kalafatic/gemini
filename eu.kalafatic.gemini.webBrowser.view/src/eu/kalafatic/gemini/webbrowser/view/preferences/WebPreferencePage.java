...
import eu.kalafatic.gemini.webbrowser.controller.PreferenceInitializer;
import eu.kalafatic.gemini.webbrowser.view.Activator;

/**
 * The Class class WebPreferencePage.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */

public class WebPreferencePage extends APreferencePage {
	...
	/**
	 * Instantiates a new web preference page.
	 */
	public WebPreferencePage() {
		super.noDefaultAndApplyButton();
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription(Activator.getPluginProperties().getString("WebPreferencePage"));
	}
