 ...
 ******************************************************************************/
package eu.kalafatic.gemini.webbrowser.controller.lib;

import eu.kalafatic.gemini.core.interfaces.IPreference;

/**
 * The Enum enum EWebPreferences.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public enum EWebPreferences implements IPreference {
	...
	/**
	 * Instantiates a new e web preferences.
	 * @param index the index
	 * @param name the name
	 * @param value the value
	 * @param def the def
	 */
	private EWebPreferences(int index, String name, Object value, Object def) {
		this.index = index;
		this.name = name;
		this.value = value;
		this.def = def;
