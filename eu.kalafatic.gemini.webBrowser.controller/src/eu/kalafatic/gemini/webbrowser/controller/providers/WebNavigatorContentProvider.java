...
/**
 * The Class class WebNavigatorContentProvider.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class WebNavigatorContentProvider implements ITreeContentProvider {
	...
	/**
	 * Instantiates a new web navigator content provider.
	 * @param inputMap the input map
	 */
	public WebNavigatorContentProvider(EMap<String, Folder> inputMap) {
